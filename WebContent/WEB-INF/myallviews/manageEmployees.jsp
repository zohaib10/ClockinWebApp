					  ...
					  <div class="form-row">
					    ...
					    <div class="form-group col-md-6">
					    	<label for="validationDefault4" style="color: black">Last Name</label>
					      	<input type="text" class="form-control input" id="validationDefault4" placeholder="Last Name" required/>
					    </div>
					  </div>
					  ...
					  <div class="form-row">
					    <div class="form-group col-md-6">
					    	<label for="validationDefault2" style="color: black">Email</label>
					      	<input type="email" class="form-control input" id="validationDefault2" placeholder="Employee Email" required/>
					    </div>
					    <div class="form-group col-md-6">
					    	<label for="validationDefault3" style="color: black">Password</label>
					    	<input type="password" class="form-control input" id="validationDefault3" placeholder="Employee Password" required/>
					    </div>
					  </div>
					   ...
					   <div class="form-row">
					    <div class="form-group col-md-6">
					    	<label for="validationDefault5" style="color: black">Phone Number</label>
					      	<input type="text" class="form-control bfh-phone input" id="validationDefault5" data-format="+1 (ddd) ddd-dddd" 
